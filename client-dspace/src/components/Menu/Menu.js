            ...
            <List>
              <Slide direction="right" in={drawerOpen} mountOnEnter unmountOnExit>
                <div>
                  ...
                  <ListItem button component={Link} to="/Dspace/Group/ListOfGroup" className={classes.listItem}>
                    <ListItemIcon><GroupIcon /></ListItemIcon>
                    <ListItemText primary="Group Management" classes={{ primary: classes.listItemText }} />
                  </ListItem>
